...
test_data_path_cf = 'C:/Users/13528/Task 1/test_fold/log_input_20230123_000000000000.csv'

###############################################################################

def counterfactual_prediction(skip_data_path,test_data_path,test_data_path_cf):
    batch_size = 1000
    ...
    preddf_new = pd.read_csv(test_data_path_cf)
    ...
    data_1 = joblib.load(skip_data_path+item[37:45]+'_y_pred_mtsk_larger_v6_1.pkl')
    pred_1 = data_1*0
...
counterfactual_prediction(skip_data_path,test_data_path,test_data_path_cf)
