...
train_file = 'C:/Users/13528/Task 1/train_fold/log_0_20180715_000000000000.csv' #change as required
###############################################################################

def fit_model(skip_data_path,train_file):
    ...
    train_0 = pd.read_csv(train_file)
    ...
    #    encoder_outputs, state_h
        ...
        output_result = Dense(11, activation='sigmoid')(output_result) #work with this 
...
fit_model(skip_data_path,train_file)